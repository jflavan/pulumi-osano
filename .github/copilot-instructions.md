...
- Toolchain versions managed by **mise** (`.config/mise.toml`): Go from the `go.mod` toolchain line (currently go1.24.10) and Pulumi from the `github.com/pulumi/pulumi/pkg/v3` version in `go.mod` (both via `scripts/get-versions.sh`), Node `24.13.0`, Python `3.11.8`, .NET `8.0.414`, Java `corretto-11`, Gradle `7.6.6`, pulumictl `0.0.50`, schema-tools `0.6.0`, golangci-lint `2.7.2`, yarn `1.22.22`. Pulumi home pinned to `.pulumi` in repo.
