...
func TestUnifiedConsentInvokes(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			token:       "getUnifiedConsent",
			args:        map[string]property.Value{"subjectRef": property.New("anon-1"), "referenceType": property.New("anonymous")},
			status:      http.StatusBadRequest,
			wantRequest: recordedUCRequest{Method: http.MethodGet, Path: ucTestPathPrefix + "/v2/consents/unified/anon-1", Query: map[string]string{"ref": "anonymous"}, UCKey: "test-uc-key"},
		...
		},
		{
			...
			wantRequest: recordedUCRequest{Method: http.MethodGet, Path: ucTestPathPrefix + "/v2/subjects/missing", Query: map[string]string{"ref": "subject"}, UCKey: "test-uc-key"},
			assert:      func(t *testing.T, ret property.Map) { assertBool(t, ret, "exists", false) },
		},
		{
			...
			wantRequest: recordedUCRequest{Method: http.MethodGet, Path: ucTestPathPrefix + "/v2/config", Query: map[string]string{}, UCKey: "test-uc-key"},
			assert: func(t *testing.T, ret property.Map) {
		...
		},
		{
			...
			status:      http.StatusNotFound,
			wantRequest: recordedUCRequest{Method: http.MethodGet, Path: ucTestPathPrefix + "/v2/collections/c-missing", Query: map[string]string{}, UCKey: "test-uc-key"},
			assert:      func(t *testing.T, ret property.Map) { assertBool(t, ret, "exists", false) },
		},
		{
			...
			wantRequest: recordedUCRequest{Method: http.MethodGet, Path: ucTestPathPrefix + "/v2/consents/check/subject-1", Query: map[string]string{}, UCKey: "test-uc-key"},
