...
namespace Community.Pulumi.Osano
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/jflavan/pulumi-osano";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Community.Pulumi.Osano.version.txt");
    ...
    internal sealed class OsanoResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public OsanoResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
